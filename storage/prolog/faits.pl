...
% INFORMATIQUE
ue(algorithmique, informatique, l1, 1, 15, 3).
ue(mathematique, informatique, l1, 1, 15, 3).
ue(physique, informatique, l1, 1, 15, 3).
ue(humanites_et_entreprises, informatique, l1, 1, 15, 2).
ue(reseau_et_systeme, informatique, l2, 2, 6, 2).

ue(systeme_information, informatique, l2, 3, 15, 2).

ue(programmation, informatique, l3, 5, 20, 2).
ue(genie_logiciel, informatique, l3, 5, 20, 2).
ue(informatique, informatique, l3, 5, 20, 2).
